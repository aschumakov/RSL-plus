...
- появились подсказки по прикладным модулям платформы (`CommonInter`, `BankInter`, `PaymInter` и другие) — 255 классов и 1555 процедур: предлагаются только там, где модуль импортирован, а наследование доходит до стандартных классов;

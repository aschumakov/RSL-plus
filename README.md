...
- worker больше не пересоздаётся при отмене — используется пул из двух тёплых worker'ов, поэтому активный файл и фоновые вкладки могут разбираться одновременно;

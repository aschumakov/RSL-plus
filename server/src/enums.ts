...
/**
 * Символы, которые всегда разделяют токены RSL.
 *
 * Важно: проверки // и /* выполняются в токенизаторе раньше,
 * чем обработка одиночного символа /.
 */
export const STOP_CHARS: string =
    ".,():;=<>![]{}+-*/%&|^~?" +
    DEFAULT_WHITESPACES;

...
export const VALUE_TYPE_CONSTANTS: readonly string[] = Object.freeze([
    ...
    "V_GENOBJ",
    /*
     * Коды ссылочных типов.
     *
     * Их нет на странице VALTYPE, но руководство пользуется ими наравне
     * с остальными: параметр процедуры «должен иметь тип,
     * соответствующий коду V_SREF или V_FREF», а для переменных этих
     * типов определено сравнение с NULL. Без них написанное по
     * документации имя оказывалось в Problems неопределённым.
     */
    "V_FREF",
    "V_SREF",
    "V_AREF",

...
const SERIAL = new Set([
    ...
    /* Меряет занятость основного потока — ей тоже нужна тишина. */
    "editing-responsiveness.test.js",
    /*
     * Меряет независимость подсказки от размера файла: сравнение времени на
     * маленьком и большом файле. Соседний процесс на том же ядре растягивает
     * маленький замер, и сравнение превращается в лотерею.
     */
